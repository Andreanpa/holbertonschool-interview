# 0x14. Heap Extract
## Details
 By: Alexa Orrico, Software Engineer at Holberton School Weight: 1Project will startSep 12, 2022 12:00 AM, must end bySep 16, 2022 12:00 AMwas released atSep 14, 2022 12:00 AM An auto review will be launched at the deadline## Requirements
### General
...
## Tasks
### 0. Heap - Extract
          mandatory         Progress vs Score  Task Body Write a function that extracts the root node of a Max Binary Heap:
...
Note: In order for the main file to compile, you are provided with  [this static library](https://s3.amazonaws.com/intranet-projects-files/holbertonschool-low_level_programming/466/libheap.a) 
